...
const Register = ({ onSubmit, isValid, canSubmit, setFormValues, ...props }) => (
  <Form formID="userRegistration" submit={onSubmit} formTitle="User Registration" {...props}>
    ...
    <Textbox type="password" label="Confirm Password" name="userConfirmPassword" placeholder="Confirm Password" isValid={isValid} validation={['isEqualToField', 'userPassword']} error="no match" setFormValues={setFormValues} />
  </Form>
);
